...
function clickPolice() {
 ...
 //  $("#Sunburst2Chart").empty();
  ...
  $.getJSON("../LMC PRoject 3 Final/3705Project3 2/AssaultRobberyDS.json", function(json) {
...
function clickNews() {
 ...
 //  $("#Sunburst2Chart").empty();
  ...
  arc = d3.svg.arc()
      ...
      .outerRadius(function(d) { return Math.max(0, y(d.y + d.dy)); });
  //    console.log("hi");
  $.getJSON("/Users/charleslee/Desktop/Work Samples/LMC Project 3 Final/3705Project3 2/NewsArticles.json", function(json) {
  //$.getJSON("file:///C:/Users/Charles/Desktop/Spring 2015/3705Project3/Sample1.json", function(json) {
  //console.log(partition.nodes(json.children); 
  nodes = partition.nodes({children: json});
  //  console.log(nodes);  
...
function clickMedia() {
  ...
  arc = d3.svg.arc()
      ...
      .outerRadius(function(d) { return Math.max(0, y(d.y + d.dy)); });
  //    console.log("hi");
  $.getJSON("/Users/charleslee/Desktop/Work Samples/LMC Project 3 Final/3705Project3 2/SharesArticles.json", function(json) {
  //$.getJSON("file:///C:/Users/Charles/Desktop/Spring 2015/3705Project3/Sample1.json", function(json) {
  //console.log(partition.nodes(json.children); 
    nodes = partition.nodes({children: json});
  //  console.log(nodes);  
...
var partition1 = d3.layout.partition()
  ...
  $.getJSON("/Users/charleslee/Desktop/Work Samples/LMC Project 3 Final/3705Project3 2/AssaultRobberyDS.json", function(json) {
  //$.getJSON("file:///C:/Users/Charles/Desktop/Spring 2015/3705Project3/Sample1.json", function(json) {
  //console.log(partition.nodes(json.children); 
